...
pub mod bigtable_client {
    ...
    where
        T: tonic::client::GrpcService<tonic::body::Body> +  hyper::service::Service<tonic::codegen::http::request::Request<tonic::body::Body>, Response = tonic::codegen::http::response::Response<T::ResponseBody>>,
        <T as hyper::service::Service<tonic::codegen::http::request::Request<tonic::body::Body>>>::Error: Into<StdError>,
